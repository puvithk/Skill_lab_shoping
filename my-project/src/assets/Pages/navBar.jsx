...
const Navbar =()=>{
    ...
    <nav className="bg-black w-screen h-10 flex justify-between items-center p-5 fixed"> 
  ...
  <span className="text-white absolute top-1/2 right-18 bg-red-700 w-3 text-[8px] h-3 flex align-middle justify-center rounded-full">{}</span>
  </button></Link>
    </div>
